...
var outputCodeDir = Path.GetFullPath("tests/Luban.IntegrationTests/TestData/collections/generated_output/code");
var outputDataDir = Path.GetFullPath("tests/Luban.IntegrationTests/TestData/collections/generated_output/data");
